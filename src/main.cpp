...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Asteroidish", NULL, NULL);
    if (window == NULL) {
    ...
    // Bind vertex array, then bind an set the vertex buffer(s), then configure attributes.
